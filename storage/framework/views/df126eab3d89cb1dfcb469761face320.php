...
unset($__errorArgs, $__bag); ?>
                        ...
                        <button class="btn btn-primary mt-2">Login</button>
                            <a href="<?php echo e(route("account.forgotPassword")); ?>" class="mt-3">Forgot Password?</a>
                        </div>
                    </form>                    
                </div>
                <div class="mt-4 text-center">
                    <p>Do not have an account? <a  href="<?php echo e(route('account.registration')); ?>">Register</a></p>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Downloads\laravel-job-portal-master\laravel-job-portal-master\resources\views/front/account/login.blade.php ENDPATH**/ ?>