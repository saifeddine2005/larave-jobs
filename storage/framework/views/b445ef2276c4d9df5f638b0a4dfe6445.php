...
<header>
	<nav class="navbar navbar-expand-lg navbar-light bg-white shadow py-3">
		<div class="container">
			<a class="navbar-brand" href="<?php echo e(route('home')); ?>">CareerVibe</a>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<?php else: ?>
					...
					<a class="btn btn-outline-primary me-2" href="<?php echo e(route('admin.dashboard')); ?>" type="submit">Admin</a>				
					<?php endif; ?>				
...
</html><?php /**PATH C:\Users\HP\Downloads\laravel-job-portal-master\laravel-job-portal-master\resources\views/front/layouts/app.blade.php ENDPATH**/ ?>