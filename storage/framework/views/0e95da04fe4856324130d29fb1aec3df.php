                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3 mb-sm-3 mb-lg-0">
                        <select name="category" id="category" class="form-control">
                            ...
                            <?php if($newCategories->isNotEmpty()): ?>
                                <?php $__currentLoopData = $newCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="row pt-5">
            ...
            <div class="col-lg-4 col-xl-3 col-md-6">
                <div class="single_catagory">
                    <a href="<?php echo e(route('jobs').'?category='.$category->id); ?>"><h4 class="pb-2"><?php echo e($category->name); ?></h4></a>
...
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Downloads\laravel-job-portal-master\laravel-job-portal-master\resources\views/front/home.blade.php ENDPATH**/ ?>